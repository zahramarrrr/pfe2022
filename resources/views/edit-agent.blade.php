...
<body>
  ...
  <main id="main" class="main">
    ...
    @if(Session::has('agent_update'))
        <span>{{Session::get('agent_update')}}</span>
        @endif
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <x-input id="name" class="form-control" type="text" name="name" value="{{$agent->name}}" required autofocus />
                        </div>
                        <div class="form-group">
                      ...
                      <div class="mt-4">
                        ...
                        <x-input id="email" class="form-control" type="email" name="email" value="{{$agent->email}}" required />
                      </div>
