      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown" aria-expanded="true">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{$commercant-> name}}</span>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle">
              <h2>{{$commercant-> prenom}} {{$commercant-> name}} </h2>
              <h3>{{$commercant-> Role}}</h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8">{{$commercant-> name}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">prénom</div>
                  <div class="col-lg-9 col-md-8">{{$commercant-> prenom}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Poste</div>
                  <div class="col-lg-9 col-md-8"> {{$commercant-> Role}}</div>
                </div>


                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Addresse</div>
                  <div class="col-lg-9 col-md-8">{{$commercant-> adresse}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Phone</div>
                  <div class="col-lg-9 col-md-8">(216) {{$commercant-> tel}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Email</div>
                  <div class="col-lg-9 col-md-8">{{$commercant-> email}}</div>
                </div>
