...
<body>
  ...
  <main id="main" class="main">
    ...
    @if(Session::has('livreur_update'))
        <span>{{Session::get('livreur_update')}}</span>
        @endif
    <form method="POST" action="{{ route('update.livreur') }}">
      @csrf

      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 text-center mb-5">
            <h2 class="heading-section">Ajouter un livreur d'entrepot:</h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <x-input id="name" class="form-control" type="text" name="name" value="{{$livreur->name}}" required autofocus />
                        </div>
                        <div class="form-group">
                      ...
                      <div class="mt-4">
                        ...
                        <x-input id="email" class="form-control" type="email" name="email" value="{{$livreur->email}}" required />
                      </div>
