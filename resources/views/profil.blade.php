...
<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-16px, 54px);">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        ...
        </li><!-- End declarer commande nav --><!-- End declarer commande nav -->
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Commerçant X</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Société</div>
                    <div class="col-lg-9 col-md-8">société commerçante</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Poste</div>
                    <div class="col-lg-9 col-md-8">responsable commercial</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">A108 Adam Street, monastir,  535022</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">(216) 486-3538 x29071</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">CommerçantX@example.com</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 100px">Directeur commercial expérimenté, plaçant le client au centre de la démarche, je m’efforce de constituer une base de clients fidèles tout en mettant en œuvre une stratégie commerciale visant à développer les ventes. Reconnue pour mes compétences managériales, je suis animée par l’épanouissement professionnel de mes équipes. Ma rigueur organisationnelle, ma réactivité et ma flexibilité me permettent d’assurer la conduite de projets simultanés afin de développer les ventes.
                    ...
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Société</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <div class="form-check">
                          ...
                          Modifications apportées à votre compte                          </label>
                        </div>
                        <div class="form-check">
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="proOffers">
                            Marketing et offre de promotion
                          </label>
                        </div>
                        <div class="form-check">
