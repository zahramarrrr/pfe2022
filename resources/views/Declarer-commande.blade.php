...
<!-- Bootstrap -->
<link type="text/css" rel="stylesheet" href="assetsliste/css/bootstrap.min.css" />

<!-- Custom stlylesheet -->
<link type="text/css" rel="stylesheet" href="assetsliste/css/style.css" />
      ...
      <li class="nav-item">
        ...
        @endif
            ...
            <div class="col-sm-6">
                       ...
                       </svg> Nom Commerçant </span>
										<input class="form-control" type="text" name="nomCommerçant" placeholder="Entrer votre nom et prénom" id="nomCommerçant">
									</div>
								</div>
                <div class="col-sm-6">
									<div class="form-group">
                           ...
                           <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
										...
										<input class="form-control" type="text" name="poids" placeholder="Entrer votre nom et prénom" id="poids">
									</div>
								</div>
                    </div>
	          <div class="row" >
                           ...
                           <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
										...
										<input class="form-control" type="text" name="nom" placeholder="Entrer le nom du client" id="nom">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
                            ...
                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
										...
										<input class="form-control" type="text"  name="prenom" placeholder="Entrer le prénom" id="prenom">
									</div>
								</div>
                <div class="col-sm-6">
									<div class="form-group">
                ...
                <div class="col-sm-6">
									<div class="form-group">
										<span class="form-label"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
                ...
                <div class="col-sm-6">
									<div class="form-group">
										<span class="form-label"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
                ...
                <div class="col-sm-6">
                      ...
                      <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
										...
										<input class="form-control" type="text" name="description" placeholder="Entrer votre  numero de télèphone" id="description" >
                    </div>
              ...
              <a href="{{route('list')}}"> <input class="submit-btn" type="submit" value="Déclarer" id="submit" name="submit" / > </a>
