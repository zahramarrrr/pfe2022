...
<head>
  ...
  <link rel="stylesheet" href="assetsajout/css/style.css">
...
<body>
  ...
  <main id="main" class="main">
    ...
    @if(Session::has('commercant_update'))
        <span>{{Session::get('commercant_update')}}</span>
        @endif
    <form method="POST" action="{{ route('update.commercant') }}">
      @csrf
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <x-input id="name" class="form-control" type="text" name="name" value="{{$commercant->name}}" required autofocus />
                        </div>
                        <div class="form-group">
                          <x-label for="prenom" :value="__('Prénom')" />
                          <input type="text" class="form-control" name="prenom" id="prenom" value="{{$commercant->prenom}}" >
                        </div>
                        <div class="form-group">
                          <x-label for="adresse" :value="__('Adresse')" />
                          <input type="text" class="form-control" name="adresse" id="adresse" value="{{$commercant->adresse}}">
                        </div>
                        <div class="form-group">
                          <x-label for="tel" :value="__('Télèphone')" />
                          <input type="text" class="form-control" name="tel" id="tel" value="{{$commercant->tel}}">
                        </div>
                      </div>
                      <div class="col-md-12">
                      </div>
                      ...
                      <div class="mt-4">
                        ...
                        <x-input id="email" class="form-control" type="email" name="email" value="{{$commercant->email}}" required />
                      </div>
